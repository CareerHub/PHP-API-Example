...
Configure::write('Routing.prefixes', array('public', 'students', 'trusted'));
 ...
 */
	Configure::write('Security.salt', 'dC5efARZDDJsKBrEpedZVJiHRhW65PhFuQc6jtXP');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '465905218183486586503947677785');
